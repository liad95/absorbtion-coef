function [H] = oneDsim(y_loc,mua,mus, mua_rect, dx, dy, Nx, Ny, lightsource_type, options)
...
vmcmedium.absorption_coefficient(rect_indices) = mua_rect;
...
vmcboundary.lightsource(1:150) = {lightsource_type};
