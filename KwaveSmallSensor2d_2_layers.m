function KwaveSmallSensor2d_2_layers(mua_layer)
...
scattering_matrix(layer_idx) = mus_layer;
...
save(['VarResults\Layer2_H_var_', num2str(mua_layer)], 'H')
analyze_H_2d_print(H,X,Y,mua,mus,g,cutoff,cutoff_end, "ValoMC", mua_layer)
...
cutoff = 30;
cutoff_end = 90;
analyze_H_2d_print(H_k_wave_recon,X,Y,mua,mus,g,cutoff,cutoff_end, "K-Wave", mua_layer)
save(['VarResults\Layer2_H_recon_var_', num2str(mua_layer)], 'H_k_wave_recon')
save(['VarResults\Layer2_Sensor_Data_var_', num2str(mua_layer)], 'sensor_data')
