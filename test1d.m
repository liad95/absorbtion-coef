...
lightsource = findBoundaries(vmcmesh, 'direction', [2 0], [2 -5], 400);
...
full_reg_energy = fullfitfunc2D(y_arr, full_parameters.mu_eff, full_parameters.D, full_parameters.a);
